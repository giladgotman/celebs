...
fun createAbaCards(): List<Card> {
    return listOf(
        ...
        Card(
            "יוסי ונחמה", "יוסי ונחמה", "giftGenerator",
        ...
        Card(
            "דני ארנהלט", "דני ארנהלט", "giftGenerator",
        ...
        Card(
            "כרמית", "כרמית", "giftGenerator",
            videoUrl1 = "text:אני הכרתי את מתי מתי שאני הכרתי את ויולה, שזה כנראה היה ממש בהתחלה...",
            videoUrl2 = "text:הזכרון הכי חזק שלי ממנו מאז ומעולם זה הוא והגיטרה..בהווייה של שמחה",
            videoUrl3 = """text:אני מאחלת שימשיך לשמוח, לנגן ולשיר, שימשיך ליהיות צעיר לנצח בדיוק כמו שהוא, ומאחלת אהבה וזוגיות טובה כי כ"כ מגיע לו את כל האושר הזה. ואם הייתי יודעת לשיר ולנגן..הייתי מקדישה לו את השיר צעיר לנצח.
                אוהבת מאוד ❤ כרמית
            """.trimIndent(),
            videoUrlFull = """
text:
...
אוהבת מאוד ❤ כרמית
        ...
        Card(
            "דן מלר", "דן מלר", "giftGenerator",
            videoUrl1 = "text: את מתי הכרתי לראשונה כשהיה בערך בן 35, במסגרת פעילות משותפת בעמותה הילונית תחיל״ה",
            videoUrl2 = "text: זיכרון חזק שלי ממתי מאותה תקופה הוא שמתי היה ״שובב״ ברעיונות מקוריים ותעוזה בלתי רגילה",
            videoUrl3 = "text: אני מאחל למתי קודם כל בריאות מרבית, ושימשיך להיות יוזם מקורי ופעיל נמרץ וחיובי כפי שהוא כיום. בברכה, למתי, דן מלר",
            videoUrlFull = """text:
...
דן מלר
        ...
        Card(
            "מוריס בן זקן", "מוריס בן זקן", "giftGenerator",
        ...
        Card(
            "ורד צלחת עם מכסה לחתול", "ורד צלחת עם מכסה לחתול", "giftGenerator",
        ...
        Card(
            "אילן גבאי", "אילן גבאי", "giftGenerator",
        ...
        Card(
            "ערן שוורץ", "ערן שוורץ", "giftGenerator",
        ...
        Card(
            "רון", "רון", "giftGenerator",
            videoUrl1 = "text: הכרתי אותו ב2015",
            videoUrl2 = "text: זיכרון מעניין זה שעשחנו הרצאה משותפת בכנס האתיאיסטים ופעילות משותפת של פתוח בשבת.",
            videoUrl3 = "text:  מאחל לו הרבה שנים של בריאות, אושר, אהבה וחירות.",
            videoUrlFull = """text:
הכרתי אותו ב2015
...
מאחל לו הרבה שנים של בריאות, אושר, אהבה וחירות.
        ...
        Card(
            "נדב ולימור תירוש", "נדב ולימור תירוש", "giftGenerator",
        ...
        Card(
            "טלי וגיא ויטנברג", "טלי וגיא ויטנברג", "giftGenerator",
        ...
        Card(
            "רון וליאור תירוש", "רון וליאור תירוש", "giftGenerator",

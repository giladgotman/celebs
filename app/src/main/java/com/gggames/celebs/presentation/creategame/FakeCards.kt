...
fun createAbaCards(): List<Card> {
    return listOf(
        ...
        Card(
            "8", "ישראל ואילה רשף", "giftGenerator",
...
דן מלר
        ...
        Card(
            "18", "ורד צלחת עם מכסה לחתול", "giftGenerator",
...
זיכרון מעניין זה שעשחנו הרצאה משותפת בכנס האתיאיסטים ופעילות משותפת של פתוח בשבת.
...
מאחל לו הרבה שנים של בריאות, אושר, אהבה וחירות.
        ...
        Card(
            "25", "נדב ולימור תירוש", "giftGenerator",
        ...
        Card(
            "26", "טלי וגיא ויטנברג", "giftGenerator",
